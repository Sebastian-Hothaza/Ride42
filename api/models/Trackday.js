...
const TrackdaySchema = new mongoose.Schema({
	...
	members: [{ user: 			{ type: mongoose.Schema.Types.ObjectId, ref: "User", required: true },
				...
				layoutVote:		[{ type: String, required: true, enum: ["none", "technical", "Rtechnical", "alien", "Ralien", "modified", "Rmodified", "long", "velocity"] }],
	...
	layout:	{ type: String, required: true, enum: ["tbd", "technical", "Rtechnical", "alien", "Ralien", "modified", "Rmodified", "long", "velocity"] },
