        ...
        <>
            <div className={styles.controlPanel}>
                ...
                <div className={styles.CPDash}>
                    ...
                    {activeTab == 'checkIn' && <CPDash_CheckIn APIServer={APIServer} allTrackdays={allTrackdays} />}
                    {activeTab == 'verify' && <CPDash_Verify APIServer={APIServer} allTrackdays={allTrackdays} />}
